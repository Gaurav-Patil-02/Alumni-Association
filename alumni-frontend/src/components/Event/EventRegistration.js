...
import { fetchWithToken, postWithToken } from '../../utils/api.js';
...
const EventRegistration = () => {
    ...
    useEffect(() => {
        async function checkRegistration() {
            try {
                ...
                const response = await fetchWithToken(`/events/${id}/registration-status`, { method: 'GET' });
    ...
    const handleRegister = async () => {
        ...
        try {
            ...
            postWithToken(`/events/${id}/register`, {userId});
